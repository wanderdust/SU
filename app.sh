...
gnome-terminal -- /bin/sh -c "cd $CA_DIR/prediction/ && echo Rasa Actions && rasa run actions --v; exec bash"
gnome-terminal -- /bin/sh -c "cd $CA_DIR/prediction/ && echo Rasa Run && rasa run; exec bash"
